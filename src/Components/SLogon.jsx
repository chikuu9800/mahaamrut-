...
export default function SLogon() {
  return (
    <section className="relative w-[100%] md:w-[80%] m-auto my-10 md:px-4 flex items-center justify-center overflow-hidden">
      {/* === Main Card Animation === */}
      <motion.div
      ...
      >
        ...
        {/* === Right: Text Content + Background Monuments === */}
        <motion.div
          className="relative w-full p-8 md:p-12 flex flex-col justify-center overflow-hidden"
          initial={{ opacity: 0, x: 60 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{
            delay: 0.8,
        ...
        >
          ...
          {/* === Foreground Text === */}
          <h1
            className="text-2xl md:text-3xl font-bold text-orange-700 leading-snug relative z-10"
            style={{ fontFamily: "baloo, sans-serif" }}
          >
            महाराष्ट्र संशोधन, उन्नती व प्रशिक्षण प्रवोधिनी (अमृत)
          </h1>
          <p
            className="text-gray-900 mt-4 text-lg max-w-3xl relative z-10"
          ...
          <p
            className="text-gray-900 mt-2 max-w-2xl relative z-10"
            style={{ fontFamily: "poppins, sans-serif" }}
          >
